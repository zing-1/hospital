...
<SCRIPT LANGUAGE="javascript" >
 ...
 <center>
 <form action="update_patientpwd.jsp" method="POST" name="form2">
	...
	<td valign="top" align="left" class="pad5">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
		    ...
		    <td width="50%" align="left" class="padl5"><input name="button1" type="button" class="button" onClick="Back()" value="返 回"></td>
          </tr>
        </table>
    </td>
  </tr>
